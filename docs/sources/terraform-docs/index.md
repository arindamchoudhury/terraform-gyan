...
| Import a single resource (hand-written `import` blocks) | 2026-08-20 | [tf-import-single](tf-import-single.md) |
...
| `terraform state push` command (checks verified + three source-found exemptions; writes no backup) | 2026-08-21 | [tf-cmd-state-push](tf-cmd-state-push.md) |
