...
| [Import resources overview](terraform-docs/tf-import.md) | documentation | 2026-08-20 | import-block, resource-identity, identity-attribute, bulk-import, queries, generate-config-out, state | [url](https://developer.hashicorp.com/terraform/language/import) |
| [Import existing resources in bulk](terraform-docs/tf-import-bulk.md) | documentation | 2026-08-20 | bulk-import, list-block, tfquery-hcl, terraform-query, generate-config-out, resource-identity, import-block, hcp-terraform | [url](https://developer.hashicorp.com/terraform/language/import/bulk) |
| [Import a single resource](terraform-docs/tf-import-single.md) | documentation | 2026-08-20 | import-block, count, for_each, instance-keys, provider-alias, modules, idempotency, resource-defaults | [url](https://developer.hashicorp.com/terraform/language/import/single-resource) |
| [Generating configuration](terraform-docs/tf-import-generate.md) | documentation | 2026-08-20 | generate-config-out, import-block, experimental, provider-block, conflicting-arguments, plan-symbols | [url](https://developer.hashicorp.com/terraform/language/import/generating-configuration) |
| [`import` block reference](terraform-docs/tf-block-import.md) | documentation | 2026-08-20 | import-block, id, identity, for_each, provider-alias, plan-time-known, modules, block-reference | [url](https://developer.hashicorp.com/terraform/language/block/import) |
| [`list` block reference](terraform-docs/tf-block-list.md) | documentation | 2026-08-20 | list-block, tfquery-hcl, terraform-query, bulk-import, count, for_each, include_resource, limit, block-reference | [url](https://developer.hashicorp.com/terraform/language/block/tfquery/list) |
| [`moved` block reference](terraform-docs/tf-block-moved.md) | documentation | 2026-08-20 | moved-block, refactoring, resource-addresses, state, block-reference | [url](https://developer.hashicorp.com/terraform/language/block/moved) |
...
| [S3 backend](terraform-docs/tf-backend-s3.md) | documentation | 2026-08-18 | backend, s3, state-locking, use_lockfile, dynamodb-deprecated, iam, workspaces, encryption, assume-role | [url](https://developer.hashicorp.com/terraform/language/backend/s3) |
| [gcs backend](terraform-docs/tf-backend-gcs.md) | documentation | 2026-08-18 | backend, gcs, state-locking, prefix, adc, impersonation, cmek, csek | [url](https://developer.hashicorp.com/terraform/language/backend/gcs) |
...
| [Update state manually overview](terraform-docs/tf-cli-state.md) | documentation | 2026-08-21 | cli, state, manual-state, backups, taint, state-mv, disaster-recovery, section-index | [url](https://developer.hashicorp.com/terraform/cli/state) |
| [Resource Address Reference](terraform-docs/tf-resource-addressing.md) | documentation | 2026-08-21 | cli, resource-addressing, module-path, instance-index, count, for-each, targeting | [url](https://developer.hashicorp.com/terraform/cli/state/resource-addressing) |
| [`terraform state` commands](terraform-docs/tf-cmd-state.md) | documentation | 2026-08-21 | cli, state, subcommands, backups, remote-state, piping, state-push | [url](https://developer.hashicorp.com/terraform/cli/commands/state) |
| [Inspect Terraform State Overview](terraform-docs/tf-cli-state-inspect.md) | documentation | 2026-08-21 | cli, state, inspection, state-list, state-show, refresh, deprecated, section-index | [url](https://developer.hashicorp.com/terraform/cli/state/inspect) |
| [Recreate Resources Overview](terraform-docs/tf-cli-state-taint.md) | documentation | 2026-08-21 | cli, state, replace-flag, taint, untaint, degraded-objects, provisioners, section-index | [url](https://developer.hashicorp.com/terraform/cli/state/taint) |
| [`terraform untaint` command](terraform-docs/tf-cmd-untaint.md) | documentation | 2026-08-21 | cli, untaint, taint, replace-flag, state, locking, legacy-flags, allow-missing | [url](https://developer.hashicorp.com/terraform/cli/commands/untaint) |
| [Move Resources](terraform-docs/tf-cli-state-move.md) | documentation | 2026-08-21 | cli, state, state-mv, state-rm, replace-provider, moved-block, refactoring, section-index | [url](https://developer.hashicorp.com/terraform/cli/state/move) |
| [`terraform state mv` command](terraform-docs/tf-cmd-state-mv.md) | documentation | 2026-08-21 | cli, state-mv, refactoring, resource-addressing, powershell, quoting, backups, dry-run | [url](https://developer.hashicorp.com/terraform/cli/commands/state/mv) |
| [`terraform state replace-provider` command](terraform-docs/tf-cmd-state-replace-provider.md) | documentation | 2026-08-21 | cli, state, replace-provider, provider-source, registry, forks, opentofu-migration, auto-approve | [url](https://developer.hashicorp.com/terraform/cli/commands/state/replace-provider) |
| [Recover State from Backup Overview](terraform-docs/tf-cli-state-recover.md) | documentation | 2026-08-21 | cli, state, disaster-recovery, force-unlock, state-pull, state-push, backups, section-index | [url](https://developer.hashicorp.com/terraform/cli/state/recover) |
| [`terraform state pull` command](terraform-docs/tf-cmd-state-pull.md) | documentation | 2026-08-21 | cli, state-pull, disaster-recovery, state-version, jq, powershell, encoding, utf-8, bom | [url](https://developer.hashicorp.com/terraform/cli/commands/state/pull) |
| [`terraform state push` command](terraform-docs/tf-cmd-state-push.md) | documentation | 2026-08-21 | cli, state-push, disaster-recovery, lineage, serial, force, safety-checks, source-verified | [url](https://developer.hashicorp.com/terraform/cli/commands/state/push) |
...
| [`terraform force-unlock` command](terraform-docs/tf-cmd-force-unlock.md) | documentation | 2026-08-19 | cli, force-unlock, state-locking, lock-id, disaster-recovery, backends | [url](https://developer.hashicorp.com/terraform/cli/commands/force-unlock) |
| [State and Plan Encryption](opentofu-docs/ot-state-encryption.md) | documentation | 2026-08-19 | opentofu, state-encryption, plan-encryption, key-provider, aes-gcm, pbkdf2, kms, openbao, fallback, migration | [url](https://opentofu.org/docs/language/state/encryption/) |
...
| [Use refresh-only mode to sync Terraform state (State)](terraform-tutorials/tut-refresh.md) | documentation | 2026-08-20 | refresh-only, terraform-refresh, drift, state, provider-misconfiguration, outputs, hcp-terraform, deprecated | [url](https://developer.hashicorp.com/terraform/tutorials/state/refresh) |
| [Develop configuration with the console (State)](terraform-tutorials/tut-console.md) | documentation | 2026-08-20 | terraform-console, repl, jsonencode, jsondecode, state-lock, outputs, json, s3-bucket-policy, expressions | [url](https://developer.hashicorp.com/terraform/tutorials/state/console) |
...
| [Target resources (State)](terraform-tutorials/tut-resource-targeting.md) | documentation | 2026-08-20 | target-flag, partial-apply, dependency-graph, count, modules, outputs, drift, exceptional-recovery | [url](https://developer.hashicorp.com/terraform/tutorials/state/resource-targeting) |
