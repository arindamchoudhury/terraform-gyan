...
So you copy the directory. That solves it for today, and what you have actually bought is a duplicate. HashiCorp's [Modules overview tutorial](https://developer.hashicorp.com/terraform/tutorials/modules/module) opens by listing what a configuration that only ever grows in one directory costs you. Four of the five are the ones you feel first:
